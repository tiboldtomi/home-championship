...
class Match extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if ((prevState.team1 !== this.state.team1 || prevState.team2 !== this.state.team2) && (!!this.state.team1 && !!this.state.team2)) {
        ...
        return (
            <div className="matches-match">
                <div className="matches-team--left">
                    ...
                    <input value={team1} onChange={e => this.setState({ team1: e.target.value.replace(/[^0-9]/g, '') })} className="input" type="text" />
                </div>
                <div className="matches-separator">{' - '}</div>
                <div className="matches-team--right">
                    <input value={team2} onChange={e => this.setState({ team2: e.target.value.replace(/[^0-9]/g, '') })} className="input" type="text" />
